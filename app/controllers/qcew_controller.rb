...
class QcewController < ApplicationController
  def index
    ...
    @area_codes = CSV.read('csv_files/qcew/area_titles.csv')
    @data_types = CSV.read('csv_files/qcew/datatype_titles.csv')
    @industries = CSV.read('csv_files/qcew/industry_titles.csv')
    @ownership = CSV.read('csv_files/qcew/ownership_titles.csv')
    @sizes = CSV.read('csv_files/qcew/size_titles.csv')
